...
public class Business extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        business = view.findViewById(R.id.recycler_business);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
        business.setLayoutManager(layoutManager);
        ...
        business.setAdapter(article_adapter);
        return view;
    }

    private void getTopArticles() {
        final ProgressDialog progressDialog = new ProgressDialog(getContext());
        progressDialog.setTitle("Business");
        progressDialog.setMessage("Loading....");
        progressDialog.show();

        BuilderAPI.apiService.getBusiness().enqueue(new Callback<ServerResponse>() {
            @Override
            public void onResponse(Call<ServerResponse> call, final Response<ServerResponse> response) {
                ...
                if (response.body() != null){
                    ...
                    business.addOnItemTouchListener(new RecyclerItemClickListener(getContext(),
